                            ...
                            <div class="justify-content-end d-flex">
                                <div class="dropdown flex-md-grow-1 flex-xl-grow-0">
                                    <form id="yearForm" method="GET" action="">
                                        <select name="year" id="year" class="form-select" onchange="document.getElementById('yearForm').submit();">
                                            @for ($i = 2020; $i <= Carbon::now('Asia/Jakarta')->year + 3; $i++)
                                                <option value="{{ $i }}" {{ request('year', Carbon::now('Asia/Jakarta')->year) == $i ? 'selected' : '' }}>
                                                    Tahun {{ $i }}
                                                </option>
                                            @endfor
                                        </select>
                                    ...
                                    @else
                                        @foreach ($upcomingKegiatan as $data)
                                            ...
                                            <div class="p-3 mb-2 rounded {{ $bgColor }} text-white">
                                                ...
                                                <h4 class="mb-0 text-warning"><strong>Status:</strong> {{ $data->status }}</h4>
                                            </div>
                                        @endforeach
                                    @endif
                                </div>
