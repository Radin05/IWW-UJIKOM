                        ...
                        <div class="col-12 col-xl-4 mt-3">
                            <div class="justify-content-end d-flex">
                                <div class="dropdown flex-md-grow-1 flex-xl-grow-0">
                                    <button class="btn btn-sm btn-light bg-white dropdown-toggle mb-3" type="button"
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuDate2">
                                        ...
                                        <a class="dropdown-item" href="#">April - Mei</a>
                                        <a class="dropdown-item" href="#">Juli - Agustus</a>
                                        <a class="dropdown-item" href="#">Oktober - Desember</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="col-md-6 stretch-card transparent">
                                    <div class="card card-light-danger">
                                        <div class="card-body">
                                            ...
                                            <p><button type="button" class="btn-light mt-2">Lihat</button></p>
                                        </div>
                                    </div>
                                </div>
                            </div>
